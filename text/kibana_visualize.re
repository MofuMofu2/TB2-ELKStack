...
#@# 自分で新しい種類のグラフを作ることは出来ますよ。もともとKibana Pluginはその位置づけのはず
#@# Kibana camvusはどちらかというとグラフ作成というよりかはレポート作成機能ですね
...
#@# 文字化けするのは2バイト文字だけで全てではないですよね。この記載だと語弊がある
...
#@# このサンプル図は棒グラフにしかみえないから、実際に取り込んだデータじゃなくてもいいけどうまく特徴が分かるものに差し替えを
