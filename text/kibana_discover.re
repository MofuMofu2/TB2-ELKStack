...
#@# Dashboardのサンプル画像なので、グラフは1個じゃなくて複数並べませんか？
...
#@# 「グラフを複数描画」というよりは「1つのグラフ内に複数要素を描画」が正しいかな
...
#@# 以降の説明において、DiscoverとDashboardの用語が混在しているから要チェックや
